...
#define ADV7393_SD_MODE_REG1_SQUARE_PIXEL	(0x10)
#define ADV7393_SD_MODE_REG2_SQUARE_PIXEL	(0xDB)
#define ADV7393_SD_MODE_REG6_SQUARE_PIXEL	(0x0C)
#define ADV7393_SD_MODE_REG7_SQUARE_PIXEL	(0x10)

#define SD_SQUARE_PIXEL_WIDTH			(640)
#define SD_SQUARE_PIXEL_HEIGHT			(480)
