...
#define DECLARE_LTC2634_CHANNELS(_name, _bits) \
	const struct iio_chan_spec _name ## _channels[] = { \
		LTC2632_CHANNEL(0, _bits), \
		LTC2632_CHANNEL(1, _bits), \
...
static DECLARE_LTC2634_CHANNELS(ltc2634x12, 12);
static DECLARE_LTC2634_CHANNELS(ltc2634x10, 10);
static DECLARE_LTC2634_CHANNELS(ltc2634x8, 8);
...
static const struct ltc2632_chip_info ltc2632_chip_info_tbl[] = {
	...
	[ID_LTC2634L12] = {
		.channels	= ltc2634x12_channels,
		.vref_mv	= 2500,
		.num_channels	= 4,
	},
	[ID_LTC2634L10] = {
		.channels	= ltc2634x10_channels,
		.vref_mv	= 2500,
		.num_channels	= 4,
	},
	[ID_LTC2634L8] =  {
		.channels	= ltc2634x8_channels,
		.vref_mv	= 2500,
		.num_channels	= 4,
	},
	[ID_LTC2634H12] = {
...
static int ltc2632_probe(struct spi_device *spi)
{
	...
	dev_info(&spi->dev, "%s device registered, %d channels\n",
		 spi_get_device_id(spi)->name, indio_dev->num_channels);
...
MODULE_DESCRIPTION("LTC263x DAC SPI driver");
